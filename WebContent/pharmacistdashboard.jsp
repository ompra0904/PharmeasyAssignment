               ...
               <c:choose>
                    ...
                    <c:otherwise>
                       <td>Not Authorized</td>
                            ...
                            <c:otherwise>
                                 <td><a href="UserController?action=updatePharmacist&patientid=<c:out value="${personmapping.personid}"/>&pharmacistid=<c:out value="${loginpersonid}"/>">Request Prescription</a></td>
                            </c:otherwise>
                            </c:choose>
                     </c:otherwise>
               </c:choose>   
